...
replace github.com/apache/pulsar-client-go => github.com/milvus-io/pulsar-client-go v0.6.8

// 替换为你的fork仓库
replace github.com/milvus-io/milvus/pkg/v2 => github.com/zhagnlu/milvus/pkg/v2 v2.0.0-20250805114351-3fe7c2533f75
